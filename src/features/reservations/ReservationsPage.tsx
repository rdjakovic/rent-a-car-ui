...
export default function ReservationsPage() {
  ...
  const filterParams: ReservationSearchParams = useMemo(() => {
    ...
    if (search.trim()) {
      // The search will be handled by the backend to search across customer name, reservation number, etc.
      // For now, we'll use a simple approach and let the backend handle the search logic
      params.customerId = isNaN(Number(search.trim())) ? undefined : Number(search.trim());
    }
